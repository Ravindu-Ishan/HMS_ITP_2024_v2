            ...
            <div className="text-xl ml-5 mb-5 font-bold text-gray-600">
                Create Prescriptions
                   ...
                   {/* <div className="form-group" style={{ marginBottom: "15px" }}>
                    <label class="block text-black font-bold md:text-right mb-1 md:mb-0 pr-4" for="inline-full-name">Date  :
                    </label>
                        <input
                            type="date"
                    ...
                    <div className="form-group" style={{ marginBottom: "15px", width: "870px" }}> 
                        ...
                        <textarea
                            ...
                            name="diagnosis"
                            rows="7" // Adjust the number of rows as needed for the desired height
